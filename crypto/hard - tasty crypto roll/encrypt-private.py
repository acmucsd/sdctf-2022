# ----- DO NOT RELEASE BEFORE END OF COMPETITION ----
# -------------!!!-ADMIN VERSION-!!!-----------------
import os
import random
import secrets
...
def generate_key():
    return (83, b'/\x83\xe7YL1\xc4\xbd\xc3a6/gT\xaa\x98') # Use fixed key to ensure reproducibility
...
print(f'Encrypting {plaintext}') # DEBUG
